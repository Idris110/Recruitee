...
export declare namespace run_v2 {
    ...
    export class Resource$Projects$Locations$Services {
        ...
        get(params?: Params$Resource$Projects$Locations$Services$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRunOpV2Service>;
        ...
        get(params: Params$Resource$Projects$Locations$Services$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRunOpV2Service>, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2Service>): void;
        get(params: Params$Resource$Projects$Locations$Services$Get, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2Service>): void;
        ...
        list(params?: Params$Resource$Projects$Locations$Services$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRunOpV2ListServicesResponse>;
        ...
        list(params: Params$Resource$Projects$Locations$Services$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRunOpV2ListServicesResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2ListServicesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Services$List, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2ListServicesResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2ListServicesResponse>): void;
        /**
         * Updates a Service.
         * @example
         * ```js
    ...
    export class Resource$Projects$Locations$Services$Revisions {
        ...
        get(params?: Params$Resource$Projects$Locations$Services$Revisions$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRunOpV2Revision>;
        ...
        get(params: Params$Resource$Projects$Locations$Services$Revisions$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRunOpV2Revision>, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2Revision>): void;
        get(params: Params$Resource$Projects$Locations$Services$Revisions$Get, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2Revision>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2Revision>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Locations$Services$Revisions$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRunOpV2ListRevisionsResponse>;
        ...
        list(params: Params$Resource$Projects$Locations$Services$Revisions$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRunOpV2ListRevisionsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2ListRevisionsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Services$Revisions$List, callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2ListRevisionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudRunOpV2ListRevisionsResponse>): void;
    }
