...
export declare namespace gkehub_v2alpha {
    ...
    export class Resource$Projects$Locations$Featureconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Featureconfigs$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Featureconfigs$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        create(params: Params$Resource$Projects$Locations$Featureconfigs$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Featureconfigs$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Featureconfigs$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Featureconfigs$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Featureconfigs$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        delete(params: Params$Resource$Projects$Locations$Featureconfigs$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Featureconfigs$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Featureconfigs$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Featureconfigs$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Featureconfigs$Get, options?: MethodOptions): GaxiosPromise<Schema$FeatureConfig>;
        get(params: Params$Resource$Projects$Locations$Featureconfigs$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Featureconfigs$Get, options: MethodOptions | BodyResponseCallback<Schema$FeatureConfig>, callback: BodyResponseCallback<Schema$FeatureConfig>): void;
        get(params: Params$Resource$Projects$Locations$Featureconfigs$Get, callback: BodyResponseCallback<Schema$FeatureConfig>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Featureconfigs$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Featureconfigs$List, options?: MethodOptions): GaxiosPromise<Schema$ListFeatureConfigsResponse>;
        list(params: Params$Resource$Projects$Locations$Featureconfigs$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Featureconfigs$List, options: MethodOptions | BodyResponseCallback<Schema$ListFeatureConfigsResponse>, callback: BodyResponseCallback<Schema$ListFeatureConfigsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Featureconfigs$List, callback: BodyResponseCallback<Schema$ListFeatureConfigsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListFeatureConfigsResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Featureconfigs$Create extends StandardParameters {
        /**
         * The ID of the feature config to create.
         */
    ...
    export interface Params$Resource$Projects$Locations$Featureconfigs$Delete extends StandardParameters {
        /**
         * Required. The name of the membershipFeature to be deleted. Specified in the format `projects/x/locations/x/featureConfigs/x*`.
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Featureconfigs$Get extends StandardParameters {
        /**
         * Required. The FeatureConfig resource name in the format `projects/x/locations/x/featureConfigs/x*`.
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Featureconfigs$List extends StandardParameters {
        /**
         * Lists FeatureConfigs that match the filter expression, following the syntax outlined in https://google.aip.dev/160.
         */
        filter?: string;
